  ...
  const education = [
   {
    ...
    },
    {
      ...
      institution: 'Yeshwantrao Chavan College, Sillod',
      year: '2021 - 2022',
      description: 'Achieved 83% with a strong foundation in science and mathematics.',
    },
    {
      degree: 'SSC',
      institution: 'New High School, Nillod',
      year: '2019 - 2020',
      description: 'Secured 81%, building a solid academic base.',
    },
  ];
